...
const Navbar = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row justify-between items-center p-4 bg-gradient-to-r from-amber-100 to-yellow-100 dark:from-slate-900 dark:to-slate-800 rounded-xl shadow-lg border-b border-gray-200 dark:border-gray-700">
      <Link to="/">
        <img
          className="h-12 md:h-16 hover:bg-amber-50 dark:hover:bg-slate-700 hover:p-2 rounded-xl cursor-pointer transition-all duration-200 hover:scale-105 shadow-md"
          src="https://download.logo.wine/logo/React_(web_framework)/React_(web_framework)-Logo.wine.png"
          alt="React"
        />
      </Link>
      <ul className="flex flex-col md:flex-row items-center gap-4 md:gap-6 text-base md:text-lg font-medium text-black dark:text-white mt-4 md:mt-0">
        ...
        <Link to="/user-profile">
          <img
            className="h-12 md:h-14 rounded-full cursor-pointer hover:border-2 border-red-600 dark:border-red-400 shadow-md transition-all duration-200 hover:scale-105"
            src={
              userDp ||
